...
<template>
    <main>
        <section class="sectioni">
            ...
            <p class="t1">Welcome, Let's get you back in</p>
            <p class="t2">Fill in your details to continue.</p>
            <form @submit.prevent="loginWithFinstack">
                <span class='spf'>
                    <label htmlFor="email">Email address</label>
                    <input v-model.trim="email" type="email" name="" id="" placeholder='Example@gmail.com' required />
                </span>
