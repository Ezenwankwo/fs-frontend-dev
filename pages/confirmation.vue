<template>
       <main>
                <section class="sectioni">
                    ...
                    <img src="~/assets/email_img.svg" alt="" class="email_img" />
                    <p class="et1">Email Confirmation</p>
                    <p class="et2">We have sent an email to you with a link to confirm your account</p>
                    <p class="et2 ea">Didn’t get the email? <a href="">Resend</a></p>
                    <a to={-1} class="gbck">
