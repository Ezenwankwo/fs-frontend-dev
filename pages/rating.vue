            ...
            <div class="p-12 mx-auto">
                <div class="w-full text-center">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-lg text-[#373D4A]">Thank you for choosing FinStack!</p>
                    </div>
                    <div class="mb-6">
                    ...
                    <button class="btn btn-block normal-case bg-[#2F67FA] mb-4 border border-0 mx-auto">facebook</button>
                    <button
                        class="btn btn-block outline outline-[#2F67FA] bg-white text-[#2F67FA] normal-case mb-6 border border-0 mx-auto">twitter</button>
                </div>
            </div>
        </div>
    </div>
