        ...
        <section class="sectioni">
            ...
            <form action="">
                <span class="spf">
                    ...
                    <span class='inp'><input type="email" name="" id="" placeholder='Enter email' /></span>
                </span>

                <span class="spf">
                    <label htmlFor="password">Create password</label>
                    <span class='inp'><input type="password" name="" id="pass" placeholder='Password' /><Icon name="bi:eye" /></span>
                </span>
                ...
                <button type="submit"><NuxtLink to="/verification">Continue</NuxtLink></button>
            </form>
        </section>
        <section class="section2 bg2">
            <div>
                <p class='q'><em>"</em></p>
...
main .bg2 {
    background-image: url(./assets/boy_img.svg);
}
